...
#   Apache 2.0
#
# https://raw.githubusercontent.com/berkshelf/berkshelf-bash-plugin/master/berkshelf-complete.sh
_bundler() {
...
_berkshelf_commands() {
  local berkshelf_dir=~/.berkshelf
  local cachefile=${berkshelf_dir}/.commands
  [ ! -d $berkshelf_dir ] && mkdir -p $berkshelf_dir
